...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 24 13:51:55 2022
...
def encrypt(string):
    ...
    for pair in strPairs:
        ...
        ind1 = find_ind(pair[0],CIPHER)
        ind2 = find_ind(pair[1],CIPHER)          

        # same row case
        if ind1[0] == ind2[0] and ind1[1] != ind2[1]:
            if ind1[1] == 4:
                en_string = en_string + CIPHER[ind1[0]][0]
            else:
                en_string = en_string + CIPHER[ind1[0]][ind1[1]+1]

            if ind2[1] == 4:
                en_string = en_string + CIPHER[ind2[0]][0]
            else:
                en_string = en_string + CIPHER[ind2[0]][ind2[1]+1]

        # same col case
        elif ind1[0] != ind2[0] and ind1[1] == ind2[1]:
            if ind1[0] == 4:
                en_string = en_string + CIPHER[0][ind1[1]]
            else:
                en_string = en_string + CIPHER[ind1[0]+1][ind1[1]]

            if ind2[0] == 4:
                en_string = en_string + CIPHER[0][ind2[1]]
            else:
                en_string = en_string + CIPHER[ind2[0]+1][ind2[1]]

        # rectangle case
        else:
            en_string = en_string + CIPHER[ind1[0]][ind2[1]]
            en_string = en_string + CIPHER[ind2[0]][ind1[1]]
...
def decrypt(string):
    ...
    for pair in strPairs:
        ...
        if ind1[0] == ind2[0] and ind1[1] != ind2[1]:
            if ind1[1] == 0:
                de_string = de_string + CIPHER[ind1[0]][-1]
            else:
                de_string = de_string + CIPHER[ind1[0]][ind1[1]-1]

            if ind2[1] == 0:
                de_string = de_string + CIPHER[ind1[0]][-1]
            else:
                de_string = de_string + CIPHER[ind2[0]][ind2[1]-1]
        
        # same col case
        elif ind1[0] != ind2[0] and ind1[1] == ind2[1]:
            if ind1[0] == 0:
                de_string = de_string + CIPHER[-1][ind1[1]]
            else:
                de_string = de_string + CIPHER[ind1[0]-1][ind1[1]]

            if ind2[0] == 0:
                de_string = de_string + CIPHER[-1][ind2[1]]
            else:
                de_string = de_string + CIPHER[ind2[0]-1][ind2[1]]
        
        # rectangle case
        else:
            de_string = de_string + CIPHER[ind1[0]][ind2[1]]
            de_string = de_string + CIPHER[ind2[0]][ind1[1]]
    
    return de_string
        
def find_ind(ch, CIPHER):
    rows = 5
    cols = 5
    for i in range(rows):
        for j in range(cols):
